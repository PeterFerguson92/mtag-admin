# Generated by Django 4.2.1 on 2024-02-04 17:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homepage_image', models.ImageField(blank=True, null=True, upload_to=homepage.uploadfiles.homepage_about_us_cover_upload_image_path, validators=[homepage.uploadfiles.homepage_about_us_image_restriction], verbose_name='Homepage Image')),
                ...
                ('image_1', models.ImageField(blank=True, null=True, upload_to=homepage.uploadfiles.homepage_about_us_cover_upload_image_path, validators=[homepage.uploadfiles.about_us_image_restriction], verbose_name='Image 1')),
                ('image_2', models.ImageField(blank=True, null=True, upload_to=homepage.uploadfiles.homepage_about_us_cover_upload_image_path, validators=[homepage.uploadfiles.about_us_image_restriction], verbose_name='Image 2')),
                ('image_3', models.ImageField(blank=True, null=True, upload_to=homepage.uploadfiles.homepage_about_us_cover_upload_image_path, validators=[homepage.uploadfiles.about_us_image_restriction], verbose_name='Image 3')),
                ('image_4', models.ImageField(blank=True, null=True, upload_to=homepage.uploadfiles.homepage_about_us_cover_upload_image_path, validators=[homepage.uploadfiles.about_us_image_restriction], verbose_name='Image 4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=homepage.uploadfiles.homepage_banner_upload_image_path, validators=[homepage.uploadfiles.homepage_banner_image_restriction], verbose_name='Image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=homepage.uploadfiles.homepage_leader_cover_upload_image_path, validators=[homepage.uploadfiles.leader_image_restriction], verbose_name='Image')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
            ],
            options={
                'verbose_name': 'Leader',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=homepage.uploadfiles.homepage_video_cover_upload_image_path, validators=[homepage.uploadfiles.video_image_restriction], verbose_name='Image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner_background_image', models.ImageField(blank=True, null=True, upload_to=homepage.uploadfiles.homepage_background_upload_image_path, validators=[homepage.uploadfiles.homepage_background_image_restriction], verbose_name='Banner Background Image')),
                ('leadership_board_background_image', models.ImageField(blank=True, null=True, upload_to=homepage.uploadfiles.homepage_background_upload_image_path, validators=[homepage.uploadfiles.homepage_background_image_restriction], verbose_name='Leadership Board Background Image')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('aboutUs', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='homepage.aboutus')),
                ('banners', models.ManyToManyField(to='homepage.banner')),
                ('blocks', models.ManyToManyField(to='homepage.block')),
                ('details', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='homepage.details')),
                ('leadershipBoard', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='homepage.leadershipboard')),
                ('media', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='homepage.media')),
            ],
            options={
